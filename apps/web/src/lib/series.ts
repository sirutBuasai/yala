...
const spendingByCategory: SeriesDef = {
...
const spendingByMonth: SeriesDef = {
...
const spendingByYear: SeriesDef = {
	id: 'spending.by_year',
...
const spendingCategoryByMonth: SeriesDef = {
...
const incomePaychecks: SeriesDef = {
	id: 'income.paychecks',
	label: 'Paychecks',
	shape: 'table',
	scopes: ['all', 'year', 'month'],
