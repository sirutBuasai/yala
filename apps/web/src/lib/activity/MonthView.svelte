...
<div class="panes">
	<div class="pendcard">
		<Pane title="Pending transactions" cap={`${label} · fronted, waiting to be paid back`}>
			{#snippet actions()}
				<div class="pactions">
					{#if pending.length}
...
<style>
	/* Gold-tinted border marks the "needs attention" pane; Pane renders the .card itself. */
