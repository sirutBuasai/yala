...
import { contributionFamily, sankeyModel } from './sankey';
import { makeData } from '../__fixtures__/dashboard';

const node = (m: ReturnType<typeof sankeyModel>, id: string) => m.nodes.find((n) => n.id === id);
const linksInto = (m: ReturnType<typeof sankeyModel>, target: string) =>
