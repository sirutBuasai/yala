...
# A transfer amount must be positive; a credit or payroll line item may be zero but never negative.
# All are finite and bounded.
...
# A spending amount takes either sign: a refund with nothing to reimburse is a negative bill.
NonZeroAmount = Annotated[
    float,
    Field(ge=-MAX_AMOUNT, le=MAX_AMOUNT, allow_inf_nan=False),
